...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MyError; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var next_error__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
function (_Error) {
  ...
  function MyError() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MyError).apply(this, arguments));
  }
  ...
  return MyError;
}(next_error__WEBPACK_IMPORTED_MODULE_1___default.a);
...
// CONCATENATED MODULE: ./constants/EndpointTypes.js
var URL = 'https://api.tvmaze.com';
var SHOW_SEARCH_ENDPOINT = URL + "/search/shows";
var SHOW_SINGLESEARCH_ENDPOINT = URL + "/singlesearch/shows";
var SHOW_LOOKUP_ENDPOINT = URL + "/lookup/shows";
var SHOW_INFO_ENDPOINT = URL + "/shows";
...
var posts_PostLink = function PostLink(props) {
  ...
  }, external_react_default.a.createElement("a", null, props.show.name)));
};
...
function (_Component) {
  ...
  _createClass(Posts, [{
    ...
    key: "render",
    value: function render() {
      if (this.props.statusCode) return external_react_default.a.createElement(_error["default"], {
        statusCode: this.props.statusCode
      });
      return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement("form", {
        action: "#",
        method: "GET"
        ...
        type: "submit"
      }, "Search")), external_react_default.a.createElement("div", null, external_react_default.a.createElement("h1", null, "Batman TV Shows"), external_react_default.a.createElement("ul", null, this.props.shows.map(function (_ref) {
        var show = _ref.show;
        return external_react_default.a.createElement(posts_PostLink, {
          key: show.id,
          show: show
        });
      }))));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 5;
            _context.next = 8;
            return external_axios_default()(SHOW_SEARCH_ENDPOINT, params);
...
/* harmony default export */ var posts = __webpack_exports__["default"] = (posts_Posts);
